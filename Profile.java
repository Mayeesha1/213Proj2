...
public class Profile {
	...
	*/
	...
	/**
	Setter method for the department code so that the value can be set in other classes
	...
	*/
	...
	/**
	Getter method for date hired of an employee so it can be used in other classes
	@return date hired
	*/
